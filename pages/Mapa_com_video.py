...
points = [
    {"name": "Ponto 1", "coords": [-8.0476, -34.8770],
        "vídeo": "https://www.youtube.com/watch?v=bW_h4mNJs1Y"},
...
st.set_page_config(
    page_title="Mapa Interativo com Vídeos e Áudios", layout="wide")
...
st.header("Mapa com Vídeos e Áudios")
